 ...
 */
public class CarsFragment extends Fragment implements SearchView.OnQueryTextListener {
    RecyclerView rv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv = (RecyclerView) v.findViewById(R.id.recyclerCars); //buscamos el id del recyclerview
