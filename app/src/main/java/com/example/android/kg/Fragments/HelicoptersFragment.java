...
public class HelicoptersFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_helicopters, container, false);

        // Inflate the layout for this fragment

        rv = (RecyclerView) v.findViewById(R.id.recyclerHelicopters); //buscamos el id del recyclerview
        ...
        tiendaref.child(FirebaseReferences.PRODUCTOS_REFERENCE).orderByChild("categoria").equalTo(3).addValueEventListener(new ValueEventListener() {
